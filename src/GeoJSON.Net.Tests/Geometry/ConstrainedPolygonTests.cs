...
namespace GeoJSON.Net.Tests.Geometry
{
    ...
    public class ConstrainedPolygonTests : TestBase
    {
        ...
        {
            var shape = GetSimpleShape();

            var expectedJson = GetExpectedJson();
            var actualJson = JsonConvert.SerializeObject(shape);
        ...
        {
            IGeometryObject shape = GetSimpleShape();
            ...
            var json = JsonConvert.SerializeObject(shape, serializerSettings);
            var result = JsonConvert.DeserializeObject<IGeometryObject>(json, serializerSettings);

            Assert.That(shape, Is.EqualTo(result));
        }
        ...
        public void Equals_GetHashCode_Contract()
        {
            ...
            var left = GetSimpleShape(offset);
            var right = GetSimpleShape(offset);
